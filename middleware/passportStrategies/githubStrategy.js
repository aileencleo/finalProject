...
var githubStrategy = new passport_github2_1.Strategy({
    //
...
function (req, accessToken, refreshToken, profile, done) { return __awaiter(void 0, void 0, void 0, function () {
    var response, emails, primaryEmail, email, user_1, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 4, , 5]);
                return [4 /*yield*/, fetch('https://api.github.com/user/emails', {
                        headers: {
            ...
            case 3:
                emails = _a.sent();
                primaryEmail = emails.find(function (email) { return email.primary && email.verified; });
                email = primaryEmail ? primaryEmail.email : '';
                console.log('GitHub profile email:', email);
                user_1 = userModel_1.userModel.findOne(email);
                if (!user_1) {
